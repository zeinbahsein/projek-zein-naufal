        ...
        <div class="px-6 py-8">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-3xl p-8 mb-5">
                    ...
                    <?php endif; ?>
                    <h1 class="text-sm font-bold text-black mb-5">Data Akun Pengguna
                        <?php if (count($users) > 0) : ?>
                            (<span class="text-blue-500"><?= count($users) ?></span>)
                        <?php else : ?>
                            (<span class="text-blue-500">0</span>)
                        <?php endif; ?> <span class="block text-sm font-normal">Kelola akun pengguna yang telah mendaftar<span class="text-yellow-500 font-bold"><?= $configs['nama_aplikasi'] ?></span> App.</span></h1>
                                ...
                                foreach ($users as $user) : ?>
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap bg-gray-50 dark:text-white dark:bg-gray-800">
                                            <button type="button" data-modal-target="edit<?= $user['id'] ?>" data-modal-toggle="edit<?= $user['id'] ?>" class="text-blue-700 hover:text-pink-500"><?= $user['username'] ?> <i class="fa fa-pencil"></i></button>
                                        </th>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <a href="/user/delete/<?= $user['id'] ?>" onclick="return confirm('Are you sure you want to delete this user?');" class="bg-red-500 font-medium py-2 px-3 rounded-md text-white"><i class="fa fa-trash"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                    ...
                                                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit<?= $user['id'] ?>">
                                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                        </svg>
                                                ...
                                                <form action="/user/update/<?= $user['id'] ?>" method="post">
                                                    <div class="p-4 md:p-5">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" id="username<?= $user['id'] ?>" name="username" value="<?= $user['username'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="password<?= $user['id'] ?>" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kata sandi</label>
                                                            <input type="password" id="password<?= $user['id'] ?>" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="role <?= $user['id'] ?>" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role</label>
                                                            <select id="role <?= $user['id'] ?>" name="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                <option value="superadmin" <?= ($user['role'] == 'superadmin') ? 'selected' : '' ?>>Admin</option>
...
<div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="/user/add" method="post">
